...
public class GrassTerrain implements TerrainType {
    ...
    private double wetness = 0.0; // saturated before becoming water
    private double heatStress = 0.0; // how much heat damage the grass has
    ...
    public void tick(Cell cell) {
        ...
        // wetness grows for flooding decision extremely slowly
        // dry slowly when no rain
        if (rain > 0) {
